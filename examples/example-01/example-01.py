...
for T in [100, 200, 300, 400, 500]:
    ax1.plot(
        nu,
        bb.spectral_radiant_sterance(T, nu, spectral_unit="Hz", area_unit="m^2"),
        label=Rf"$T={T}\,\mathrm{{K}}$",
    )
    ax2.plot(
        nu,
        bb.spectral_photon_sterance(T, nu, spectral_unit="Hz", area_unit="m^2"),
        label=Rf"$T={T}\,\mathrm{{K}}$",
    )
...
for T in [100, 200, 300, 400, 500]:
    ax1.plot(
        xlambda,
        bb.spectral_radiant_sterance(T, xlambda, spectral_unit="um", area_unit="m^2"),
        label=Rf"$T={T}\,\mathrm{{K}}$",
    )
    ax2.plot(
        xlambda,
        bb.spectral_photon_sterance(T, xlambda, spectral_unit="um", area_unit="m^2"),
        label=Rf"$T={T}\,\mathrm{{K}}$",
    )
...
for T in [100, 200, 300, 400, 500]:
    ax1.plot(
        sigma,
        bb.spectral_radiant_sterance(T, sigma, spectral_unit="cm^-1", area_unit="m^2"),
        label=Rf"$T={T}\,\mathrm{{K}}$",
    )
    ax2.plot(
        sigma,
        bb.spectral_photon_sterance(T, sigma, spectral_unit="cm^-1", area_unit="m^2"),
        label=Rf"$T={T}\,\mathrm{{K}}$",
    )
